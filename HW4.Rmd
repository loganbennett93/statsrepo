...
b.
As the results of the rank-sum test given above show, the exact *p*-value was not reported due to ties in the data, so instead the one based off the normal approximation.

c.
No. It does not use a continuity correction to the Z-statistic.
